...
performance, and integrates well with the rest of the system.
...
reference guide]]. These references are for your own understanding and are optional.
...
- Advanced topics, which are optional (directories starting with advancedXX)
...
We recommend completing the advanced lessons in case you have time, but these
are optional and will not hinder your progress in subsequent labs coming after
the first two weeks.
...
The lab spans the first two weeks, and has a deadline at 23:59 on 22/9/24. This
lab comprises 15% of the total labs part of this course. The final submission
will be through a link to the commit containing solutions for basic and packet
